...
```
The MQTT publish topic in this code example will be `WAGO-PFC200/Out/Virtual/FB_VIRTUAL_INT_001` (MQTTPubSwitchPrefix variable + function block name). The subscription topic will be `WAGO-PFC200/In/Virtual/FB_VIRTUAL_INT_001` (MQTTSubSwitchPrefix variable + function block name).
