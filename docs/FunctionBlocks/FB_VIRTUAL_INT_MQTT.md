...
```
The MQTT publish topic in this code example will be `WAGO-PFC200/Out/Virtuals/FB_VIRTUAL_INT_001` (MQTTPubSwitchPrefix variable + function block name). The subscription topic will be `WAGO-PFC200/In/Virtuals/FB_VIRTUAL_INT_001` (MQTTSubSwitchPrefix variable + function block name).
...
- platform: MQTT
  ...
  state_topic: "WAGO-PFC200/Out/Virtuals/FB_VIRTUAL_INT_001"
  qos: 2  
...
- id: fb_virtual_int_001-to-mqtt
  ...
  action:
    ...
    data_template:
      topic: 'WAGO-PFC200/In/Virtuals/FB_VIRTUAL_INT_001'
      retain: true
